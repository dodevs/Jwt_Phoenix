defmodule JwtApp.Accounts do
  ...
  def get_user_by_username_and_password(username, password) do
    # O usuario existindo e a senha informada estando certa, retorna {:ok, user}
    with %User{} = user <- Repo.get_by(User, username: String.downcase(username)),
      ...
      _ ->
        Comeonin.Bcrypt.dummy_checkpw # Mitiga o timing attack
        {:error, :unauthorized}
    end
  end
end
